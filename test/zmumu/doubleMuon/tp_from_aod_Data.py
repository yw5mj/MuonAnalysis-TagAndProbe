...
'/store/data/Run2015D/SingleMuon/AOD/PromptReco-v3/000/258/158/00000/5A832E55-656B-E511-81CF-02163E013820.root'
]
...
process.probeMuons = cms.EDFilter("PATMuonSelector",
    src = cms.InputTag("patMuonsWithTrigger"),
    cut = cms.string("pt > 5 && "+MuonIDFlags.Tight2012.value())
)
